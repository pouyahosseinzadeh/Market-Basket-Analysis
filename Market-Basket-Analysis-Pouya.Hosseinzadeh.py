...
df1 = pd.read_csv(r"D:\DRIVE D\daneshgah.arshad\UNISIENA\Advanced database systems\DATASET/transactions.csv")
df2 = pd.read_csv(r"D:\DRIVE D\daneshgah.arshad\UNISIENA\Advanced database systems\DATASET/segments-description.csv")
...
# for simplisity we prefer to work on 10000 transactions rather than nearly 1 million which fails the computer RAM
df=df.iloc[0:10000]
df
...
# Association rules function is used which can take any metricsuch as'lift' and also the minimum threshold set to 1
